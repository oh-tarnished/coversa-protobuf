...
// banner marks the index as generated, in the callout GitHub renders.
//
// The per-package pages carry their provenance in a footer instead: a reader
// who has scrolled a reference to its end is better served by a link to the
// source than by a warning they saw six screens ago.
func (g *Generator) banner() string {
	return "> [!IMPORTANT]\n" +
		"> Auto-generated by `just docs` from COVESA VSS `" + g.M.Spec.VSS.Version +
		"` (`" + g.M.Spec.VSS.Short() + "`) and VDM `" + g.M.Spec.VDM.Version +
		"` (`" + g.M.Spec.VDM.Short() + "`).\n" +
