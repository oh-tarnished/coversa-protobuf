...
| --- | --- | --- | --- | --- |
| `wiping` | `Wiping` | `OPTIONAL` | — | Windshield wiper signals. |
| `is_heating_on` | `bool` | `OPTIONAL` | — | Windshield heater status. False - off, True - on. |
| `washer_fluid` | `WasherFluid` | `OPTIONAL` | — | Windshield washer fluid signals |
...
| `system` | `System` | `OPTIONAL` | — | Signals to control behavior of wipers in detail. By default VSS expects only one instance. |
