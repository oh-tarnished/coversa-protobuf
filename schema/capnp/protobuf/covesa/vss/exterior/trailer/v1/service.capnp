...
# 	protoc (unknown)
# source: protobuf/covesa/vss/exterior/trailer/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/exterior/trailer/v1/messages.capnp";
using Trailer = import "/protobuf/covesa/vss/exterior/trailer/v1/trailer.capnp";

# Trailers manages the Trailer branch of a vehicle.
#
...
interface Trailers @0xc91cd6d1861a7eea {
  # Retrieves one Trailer.
  #
  ...
  updateTrailer @1 (request :Messages.UpdateTrailerRequest) -> (response :Trailer.Trailer);
}
