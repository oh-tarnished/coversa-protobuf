...
# 	protoc (unknown)
# source: protobuf/covesa/vss/exterior/direction_indicator/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/exterior/direction_indicator/v1/messages.capnp";

# DirectionIndicators manages the DirectionIndicator branch of a vehicle.
#
...
interface DirectionIndicators @0x957c051472ded7ab {
  # Retrieves one DirectionIndicator.
  #
  ...
  #
  # NOT_FOUND no such DirectionIndicator
  # INVALID_ARGUMENT name does not match the resource pattern
  # PERMISSION_DENIED caller may not read it
  # AIP-131 standard method.
  getDirectionIndicator @0 (request :Messages.GetDirectionIndicatorRequest) -> (response :DirectionIndicator.DirectionIndicator);

  # Lists the directionIndicators of one vehicle.
  #
  ...
  listDirectionIndicators @1 (request :Messages.ListDirectionIndicatorsRequest) -> (response :Messages.ListDirectionIndicatorsResponse);

  # Creates a DirectionIndicator.
  #
  # POST /v1/{parent=vehicles/*}/directionIndicators
  # body: the DirectionIndicator itself
  #
  ...
  # DirectionIndicator; supply `direction_indicator_id` if the caller needs
  # retry safety.
  #
  ...
  createDirectionIndicator @2 (request :Messages.CreateDirectionIndicatorRequest) -> (response :DirectionIndicator.DirectionIndicator);

  # Updates a DirectionIndicator.
  #
  # PATCH /v1/{direction_indicator.name=vehicles/*/directionIndicators/*}
  # body: the DirectionIndicator itself
  #
  ...
  updateDirectionIndicator @3 (request :Messages.UpdateDirectionIndicatorRequest) -> (response :DirectionIndicator.DirectionIndicator);

  # Deletes a DirectionIndicator.
  #
  # DELETE /v1/{name=vehicles/*/directionIndicators/*}
  #
  # Soft delete: the DirectionIndicator is marked deleted, disappears from
  # List unless `show_deleted` is set, and is purged at `expire_time`.
  # Recover it with UndeleteDirectionIndicator before then.
  #
  ...
  deleteDirectionIndicator @4 (request :Messages.DeleteDirectionIndicatorRequest) -> ();

  # Restores a soft-deleted DirectionIndicator.
  #
  # POST /v1/{name=vehicles/*/directionIndicators/*}:undelete
  #
  # Valid only before `expire_time`; after that the DirectionIndicator is
  # gone and this returns NOT_FOUND. Clears `delete_time` and `expire_time`.
  #
  # NOT_FOUND no such DirectionIndicator, or already purged
  # ALREADY_EXISTS the DirectionIndicator is not deleted
  # PERMISSION_DENIED caller may not restore it
  # AIP-164 standard method.
  undeleteDirectionIndicator @5 (request :Messages.UndeleteDirectionIndicatorRequest) -> (response :DirectionIndicator.DirectionIndicator);
}
