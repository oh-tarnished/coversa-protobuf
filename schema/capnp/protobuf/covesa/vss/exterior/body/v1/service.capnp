...
# 	protoc (unknown)
# source: protobuf/covesa/vss/exterior/body/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/exterior/body/v1/messages.capnp";

# Bodies manages the Body branch of a vehicle.
#
...
interface Bodies @0x8a21f26f81f9e16d {
  # Retrieves one Body.
  #
  ...
  updateBody @1 (request :Messages.UpdateBodyRequest) -> (response :Body.Body);
}
