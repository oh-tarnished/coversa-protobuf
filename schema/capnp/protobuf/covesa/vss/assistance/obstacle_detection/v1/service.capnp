...
# 	protoc (unknown)
# source: protobuf/covesa/vss/assistance/obstacle_detection/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/assistance/obstacle_detection/v1/messages.capnp";
using ObstacleDetection = import "/protobuf/covesa/vss/assistance/obstacle_detection/v1/obstacle_detection.capnp";

# ObstacleDetections manages the ObstacleDetection branch of a vehicle.
#
...
interface ObstacleDetections @0xcf29d12053472706 {
  # Retrieves one ObstacleDetection.
  #
  ...
  #
  # NOT_FOUND no such ObstacleDetection
  # INVALID_ARGUMENT name does not match the resource pattern
  # PERMISSION_DENIED caller may not read it
  # AIP-131 standard method.
  getObstacleDetection @0 (request :Messages.GetObstacleDetectionRequest) -> (response :ObstacleDetection.ObstacleDetection);

  # Lists the obstacleDetections of one vehicle.
  #
  ...
  listObstacleDetections @1 (request :Messages.ListObstacleDetectionsRequest) -> (response :Messages.ListObstacleDetectionsResponse);

  # Creates a ObstacleDetection.
  #
  # POST /v1/{parent=vehicles/*}/obstacleDetections
  # body: the ObstacleDetection itself
  #
  ...
  # ObstacleDetection; supply `obstacle_detection_id` if the caller needs
  # retry safety.
  #
  ...
  createObstacleDetection @2 (request :Messages.CreateObstacleDetectionRequest) -> (response :ObstacleDetection.ObstacleDetection);

  # Updates a ObstacleDetection.
  #
  # PATCH /v1/{obstacle_detection.name=vehicles/*/obstacleDetections/*}
  # body: the ObstacleDetection itself
  #
  ...
  updateObstacleDetection @3 (request :Messages.UpdateObstacleDetectionRequest) -> (response :ObstacleDetection.ObstacleDetection);

  # Deletes a ObstacleDetection.
  #
  # DELETE /v1/{name=vehicles/*/obstacleDetections/*}
  #
  # Soft delete: the ObstacleDetection is marked deleted, disappears from
  # List unless `show_deleted` is set, and is purged at `expire_time`.
  # Recover it with UndeleteObstacleDetection before then.
  #
  ...
  deleteObstacleDetection @4 (request :Messages.DeleteObstacleDetectionRequest) -> ();

  # Restores a soft-deleted ObstacleDetection.
  #
  # POST /v1/{name=vehicles/*/obstacleDetections/*}:undelete
  #
  # Valid only before `expire_time`; after that the ObstacleDetection is
  # gone and this returns NOT_FOUND. Clears `delete_time` and `expire_time`.
  #
  # NOT_FOUND no such ObstacleDetection, or already purged
  # ALREADY_EXISTS the ObstacleDetection is not deleted
  # PERMISSION_DENIED caller may not restore it
  # AIP-164 standard method.
  undeleteObstacleDetection @5 (request :Messages.UndeleteObstacleDetectionRequest) -> (response :ObstacleDetection.ObstacleDetection);
}
