...
# 	protoc (unknown)
# source: protobuf/covesa/vss/propulsion/powertrain/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/propulsion/powertrain/v1/messages.capnp";
using Powertrain = import "/protobuf/covesa/vss/propulsion/powertrain/v1/powertrain.capnp";

# PowertrainService manages the Powertrain branch of a vehicle.
#
...
interface PowertrainService @0x968d001c17f7df68 {
  # Retrieves one Powertrain.
  #
  ...
  updatePowertrain @1 (request :Messages.UpdatePowertrainRequest) -> (response :Powertrain.Powertrain);
}
