...
# 	protoc (unknown)
# source: protobuf/covesa/vss/motion/chassis_axle/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/motion/chassis_axle/v1/messages.capnp";

# ChassisAxles manages the ChassisAxle branch of a vehicle.
#
...
interface ChassisAxles @0xfe3111e9c6d09fec {
  # Retrieves one ChassisAxle.
  #
  ...
  #
  # NOT_FOUND no such ChassisAxle
  # INVALID_ARGUMENT name does not match the resource pattern
  # PERMISSION_DENIED caller may not read it
  # AIP-131 standard method.
  getChassisAxle @0 (request :Messages.GetChassisAxleRequest) -> (response :ChassisAxle.ChassisAxle);

  # Lists the chassisAxles of one vehicle.
  #
  ...
  listChassisAxles @1 (request :Messages.ListChassisAxlesRequest) -> (response :Messages.ListChassisAxlesResponse);

  # Creates a ChassisAxle.
  #
  # POST /v1/{parent=vehicles/*}/chassisAxles
  # body: the ChassisAxle itself
  #
  ...
  # ChassisAxle; supply `chassis_axle_id` if the caller needs retry safety.
  #
  ...
  createChassisAxle @2 (request :Messages.CreateChassisAxleRequest) -> (response :ChassisAxle.ChassisAxle);

  # Updates a ChassisAxle.
  #
  # PATCH /v1/{chassis_axle.name=vehicles/*/chassisAxles/*}
  # body: the ChassisAxle itself
  #
  ...
  updateChassisAxle @3 (request :Messages.UpdateChassisAxleRequest) -> (response :ChassisAxle.ChassisAxle);

  # Deletes a ChassisAxle.
  #
  # DELETE /v1/{name=vehicles/*/chassisAxles/*}
  #
  # Soft delete: the ChassisAxle is marked deleted, disappears from List
  # unless `show_deleted` is set, and is purged at `expire_time`. Recover it
  # with UndeleteChassisAxle before then.
  #
  ...
  deleteChassisAxle @4 (request :Messages.DeleteChassisAxleRequest) -> ();

  # Restores a soft-deleted ChassisAxle.
  #
  # POST /v1/{name=vehicles/*/chassisAxles/*}:undelete
  #
  # Valid only before `expire_time`; after that the ChassisAxle is gone and
  # this returns NOT_FOUND. Clears `delete_time` and `expire_time`.
  #
  # NOT_FOUND no such ChassisAxle, or already purged
  # ALREADY_EXISTS the ChassisAxle is not deleted
  # PERMISSION_DENIED caller may not restore it
  # AIP-164 standard method.
  undeleteChassisAxle @5 (request :Messages.UndeleteChassisAxleRequest) -> (response :ChassisAxle.ChassisAxle);
}
