...
# 	protoc (unknown)
# source: protobuf/covesa/vss/motion/electric_axle/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/motion/electric_axle/v1/messages.capnp";

# ElectricAxles manages the ElectricAxle branch of a vehicle.
#
...
interface ElectricAxles @0xcc9f1104ce102d84 {
  # Retrieves one ElectricAxle.
  #
  ...
  #
  # NOT_FOUND no such ElectricAxle
  # INVALID_ARGUMENT name does not match the resource pattern
  # PERMISSION_DENIED caller may not read it
  # AIP-131 standard method.
  getElectricAxle @0 (request :Messages.GetElectricAxleRequest) -> (response :ElectricAxle.ElectricAxle);

  # Lists the electricAxles of one vehicle.
  #
  ...
  listElectricAxles @1 (request :Messages.ListElectricAxlesRequest) -> (response :Messages.ListElectricAxlesResponse);

  # Creates a ElectricAxle.
  #
  # POST /v1/{parent=vehicles/*}/electricAxles
  # body: the ElectricAxle itself
  #
  ...
  # ElectricAxle; supply `electric_axle_id` if the caller needs retry
  # safety.
  #
  ...
  createElectricAxle @2 (request :Messages.CreateElectricAxleRequest) -> (response :ElectricAxle.ElectricAxle);

  # Updates a ElectricAxle.
  #
  # PATCH /v1/{electric_axle.name=vehicles/*/electricAxles/*}
  # body: the ElectricAxle itself
  #
  ...
  updateElectricAxle @3 (request :Messages.UpdateElectricAxleRequest) -> (response :ElectricAxle.ElectricAxle);

  # Deletes a ElectricAxle.
  #
  # DELETE /v1/{name=vehicles/*/electricAxles/*}
  #
  # Soft delete: the ElectricAxle is marked deleted, disappears from List
  # unless `show_deleted` is set, and is purged at `expire_time`. Recover it
  # with UndeleteElectricAxle before then.
  #
  ...
  deleteElectricAxle @4 (request :Messages.DeleteElectricAxleRequest) -> ();

  # Restores a soft-deleted ElectricAxle.
  #
  # POST /v1/{name=vehicles/*/electricAxles/*}:undelete
  #
  # Valid only before `expire_time`; after that the ElectricAxle is gone and
  # this returns NOT_FOUND. Clears `delete_time` and `expire_time`.
  #
  # NOT_FOUND no such ElectricAxle, or already purged
  # ALREADY_EXISTS the ElectricAxle is not deleted
  # PERMISSION_DENIED caller may not restore it
  # AIP-164 standard method.
  undeleteElectricAxle @5 (request :Messages.UndeleteElectricAxleRequest) -> (response :ElectricAxle.ElectricAxle);
}
