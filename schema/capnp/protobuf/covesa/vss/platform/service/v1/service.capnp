...
# 	protoc (unknown)
# source: protobuf/covesa/vss/platform/service/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/platform/service/v1/messages.capnp";
using ServiceResource = import "/protobuf/covesa/vss/platform/service/v1/service_resource.capnp";

# Services manages the Service branch of a vehicle.
#
...
interface Services @0xedd6c6e49d813156 {
  ...
  getService @0 (request :Messages.GetServiceRequest) -> (response :ServiceResource.Service);

  # Updates a Service.
  #
  # PATCH /v1/{service.name=vehicles/*/service}
  # body: the Service itself
  #
  ...
  updateService @1 (request :Messages.UpdateServiceRequest) -> (response :ServiceResource.Service);
}
