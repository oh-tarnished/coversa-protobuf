...
# 	protoc (unknown)
# source: protobuf/covesa/vss/interior/ambient_light/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/interior/ambient_light/v1/messages.capnp";

# AmbientLights manages the AmbientLight branch of a vehicle.
#
...
interface AmbientLights @0xb258fec992bf36e2 {
  # Retrieves one AmbientLight.
  #
  ...
  #
  # NOT_FOUND no such AmbientLight
  # INVALID_ARGUMENT name does not match the resource pattern
  # PERMISSION_DENIED caller may not read it
  # AIP-131 standard method.
  getAmbientLight @0 (request :Messages.GetAmbientLightRequest) -> (response :AmbientLight.AmbientLight);

  # Lists the ambientLights of one vehicle.
  #
  ...
  listAmbientLights @1 (request :Messages.ListAmbientLightsRequest) -> (response :Messages.ListAmbientLightsResponse);

  # Creates a AmbientLight.
  #
  # POST /v1/{parent=vehicles/*}/ambientLights
  # body: the AmbientLight itself
  #
  ...
  # AmbientLight; supply `ambient_light_id` if the caller needs retry
  # safety.
  #
  ...
  createAmbientLight @2 (request :Messages.CreateAmbientLightRequest) -> (response :AmbientLight.AmbientLight);

  # Updates a AmbientLight.
  #
  # PATCH /v1/{ambient_light.name=vehicles/*/ambientLights/*}
  # body: the AmbientLight itself
  #
  ...
  updateAmbientLight @3 (request :Messages.UpdateAmbientLightRequest) -> (response :AmbientLight.AmbientLight);

  # Deletes a AmbientLight.
  #
  # DELETE /v1/{name=vehicles/*/ambientLights/*}
  #
  # Soft delete: the AmbientLight is marked deleted, disappears from List
  # unless `show_deleted` is set, and is purged at `expire_time`. Recover it
  # with UndeleteAmbientLight before then.
  #
  ...
  deleteAmbientLight @4 (request :Messages.DeleteAmbientLightRequest) -> ();

  # Restores a soft-deleted AmbientLight.
  #
  # POST /v1/{name=vehicles/*/ambientLights/*}:undelete
  #
  # Valid only before `expire_time`; after that the AmbientLight is gone and
  # this returns NOT_FOUND. Clears `delete_time` and `expire_time`.
  #
  # NOT_FOUND no such AmbientLight, or already purged
  # ALREADY_EXISTS the AmbientLight is not deleted
  # PERMISSION_DENIED caller may not restore it
  # AIP-164 standard method.
  undeleteAmbientLight @5 (request :Messages.UndeleteAmbientLightRequest) -> (response :AmbientLight.AmbientLight);
}
