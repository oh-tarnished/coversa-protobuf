...
# 	protoc (unknown)
# source: protobuf/covesa/vss/interior/driver/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/interior/driver/v1/messages.capnp";

# Drivers manages the Driver branch of a vehicle.
#
...
interface Drivers @0x8771373ecbececf5 {
  # Retrieves one Driver.
  #
  ...
  updateDriver @1 (request :Messages.UpdateDriverRequest) -> (response :Driver.Driver);
}
