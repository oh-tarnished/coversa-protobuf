...
# 	protoc (unknown)
# source: protobuf/covesa/vss/interior/occupant/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vss/interior/occupant/v1/messages.capnp";
using Occupant = import "/protobuf/covesa/vss/interior/occupant/v1/occupant.capnp";

# Occupants manages the Occupant branch of a vehicle.
#
...
interface Occupants @0xc9b952dc20f564ff {
  # Retrieves one Occupant.
  #
  ...
  #
  # NOT_FOUND no such Occupant
  # INVALID_ARGUMENT name does not match the resource pattern
  # PERMISSION_DENIED caller may not read it
  # AIP-131 standard method.
  getOccupant @0 (request :Messages.GetOccupantRequest) -> (response :Occupant.Occupant);

  # Lists the occupants of one vehicle.
  #
  ...
  listOccupants @1 (request :Messages.ListOccupantsRequest) -> (response :Messages.ListOccupantsResponse);

  # Creates a Occupant.
  #
  # POST /v1/{parent=vehicles/*}/occupants
  # body: the Occupant itself
  #
  ...
  #
  # Not idempotent. Retrying after a timeout may create a second Occupant;
  # supply `occupant_id` if the caller needs retry safety.
  #
  ...
  createOccupant @2 (request :Messages.CreateOccupantRequest) -> (response :Occupant.Occupant);
  ...
  updateOccupant @3 (request :Messages.UpdateOccupantRequest) -> (response :Occupant.Occupant);

  # Deletes a Occupant.
  #
  # DELETE /v1/{name=vehicles/*/occupants/*}
  #
  # Soft delete: the Occupant is marked deleted, disappears from List unless
  # `show_deleted` is set, and is purged at `expire_time`. Recover it with
  # UndeleteOccupant before then.
  #
  ...
  deleteOccupant @4 (request :Messages.DeleteOccupantRequest) -> ();

  # Restores a soft-deleted Occupant.
  #
  # POST /v1/{name=vehicles/*/occupants/*}:undelete
  #
  # Valid only before `expire_time`; after that the Occupant is gone and
  # this returns NOT_FOUND. Clears `delete_time` and `expire_time`.
  #
  # NOT_FOUND no such Occupant, or already purged
  # ALREADY_EXISTS the Occupant is not deleted
  # PERMISSION_DENIED caller may not restore it
  # AIP-164 standard method.
  undeleteOccupant @5 (request :Messages.UndeleteOccupantRequest) -> (response :Occupant.Occupant);
}
