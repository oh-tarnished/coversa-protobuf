...
# 	protoc (unknown)
# source: protobuf/covesa/vdm/location/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vdm/location/v1/messages.capnp";

# Locations manages the Location branch of a vehicle.
#
...
interface Locations @0xeb830348aabd9928 {
  ...
  getLocation @0 (request :Messages.GetLocationRequest) -> (response :Location.Location);

  # Updates a Location.
  #
  # PATCH /v1/{location.name=chargingStations/*/location}
  # body: the Location itself
  #
  ...
  updateLocation @1 (request :Messages.UpdateLocationRequest) -> (response :Location.Location);
}
