...
# 	protoc (unknown)
# source: protobuf/covesa/vdm/person/v1/service.proto
#
# target: capnp
...
using Messages = import "/protobuf/covesa/vdm/person/v1/messages.capnp";
using Person = import "/protobuf/covesa/vdm/person/v1/person.capnp";

# People manages the Person branch of a vehicle.
#
...
interface People @0xcb33f1f042aefe06 {
  ...
  getPerson @0 (request :Messages.GetPersonRequest) -> (response :Person.Person);

  # Lists the people of one vehicle.
  #
  # GET /v1/people
  #
  ...
  listPeople @1 (request :Messages.ListPeopleRequest) -> (response :Messages.ListPeopleResponse);

  # Creates a Person.
  #
  # POST /v1/people
  # body: the Person itself
  #
  ...
  #
  # Not idempotent. Retrying after a timeout may create a second Person;
  # supply `person_id` if the caller needs retry safety.
  #
  ...
  createPerson @2 (request :Messages.CreatePersonRequest) -> (response :Person.Person);
  ...
  updatePerson @3 (request :Messages.UpdatePersonRequest) -> (response :Person.Person);

  # Deletes a Person.
  #
  # DELETE /v1/{name=people/*}
  #
  # Soft delete: the Person is marked deleted, disappears from List unless
  # `show_deleted` is set, and is purged at `expire_time`. Recover it with
  # UndeletePerson before then.
  #
  ...
  deletePerson @4 (request :Messages.DeletePersonRequest) -> ();

  # Restores a soft-deleted Person.
  #
  # POST /v1/{name=people/*}:undelete
  #
  # Valid only before `expire_time`; after that the Person is gone and this
  # returns NOT_FOUND. Clears `delete_time` and `expire_time`.
  #
  # NOT_FOUND no such Person, or already purged
  # ALREADY_EXISTS the Person is not deleted
  # PERMISSION_DENIED caller may not restore it
  # AIP-164 standard method.
  undeletePerson @5 (request :Messages.UndeletePersonRequest) -> (response :Person.Person);
}
